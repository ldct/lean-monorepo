/-
Extracts extra hierarchy metadata for site/normedfield_hierarchy_staging.html:
...
Input:  scripts/hierarchy_input_staging.json  (nodes, edges, owners, roster)
Output: site/hierarchy_extras_staging.json
...
#eval show Elab.Command.CommandElabM Unit from do
  ...
  Elab.Command.liftTermElabM do
    ...
    IO.FS.writeFile "site/hierarchy_extras_staging.json" out.compress
    IO.println "wrote site/hierarchy_extras_staging.json"
