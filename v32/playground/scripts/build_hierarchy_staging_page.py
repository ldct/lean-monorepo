...
page=page.replace('<title>NormedField structure hierarchy — Mathlib (July 2026)</title>', '<title>STAGING — expanded NormedField structure hierarchy</title>')
page=page.replace('Mathlib v4.32.0-rc1-patch1 · 101 classes, 142 drawn edges (transitively reduced) · solid = extends/projection, dashed = derived instance · layout grouped by subject area', 'Mathlib v4.32.0 · commit 81a5d257 · 117 classes, 221 drawn edges · every direct extends edge retained · dashed = curated/canonical derived instance · wider staging layout')
...
page=page.replace('<code>extends</code> closure from <code>NormedField</code> plus source-verified <code>instance</code> edges, transitively reduced.', '<code>extends</code>-complete selected set plus source-verified <code>instance</code> edges; direct parent arrows are intentionally not transitively reduced.')
page=page.replace('<body>', '<body>\n<div id="staging-banner" style="position:fixed;z-index:30;left:50%;transform:translateX(-50%);top:8px;background:#8a4b08;color:white;padding:5px 12px;border-radius:999px;font:700 12px system-ui;box-shadow:0 1px 6px #0005;pointer-events:none">STAGING REVIEW · 117 nodes · 221 edges · production page untouched</div>',1)
