...
def realAlgebraReal : RealAlgebra 1 ℝ where
  toVec r := fun _ => r
  mul₁ l x y z := by
...
noncomputable def realAlgebraComplex : RealAlgebra 2 ℂ where
...
noncomputable def realAlgebraQuaternion : RealAlgebra 4 (Quaternion ℝ) where
