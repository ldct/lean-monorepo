...
This project request had uuid: 8477a662-8170-47e7-943e-81e1c5151d20

The following was proved by Aristotle:

- example {G : Type} [AddCommGroup G] : IsAddSubgroup (TorsionSet G)
...
example {G : Type} [AddCommGroup G] : IsAddSubgroup (TorsionSet G) := by
  refine' ⟨ _, _, _ ⟩;
  · exact ⟨ 0, by simp +decide [ TorsionSet ] ⟩;
  · simp +decide [ TorsionSet ];
    exact?;
  · unfold TorsionSet; aesop;
